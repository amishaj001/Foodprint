...
def main():
	...
	if input("Is this your first day using Foodprint? (Y/N) ") == "Y":
		print("For your first day of tracking your dietary carbon footprint, your carbon footpring was approximately " + str(ghg_sum) + "! Try to lower this number tomorrow by making less emission-heavy dietary choices!")
	else:
		last_day = float(input("Today your dietary carbon footprint was approximately " + str(ghg_sum) + " kilograms of CO2eq emissions. What was your dietary carbon footprint (in kilograms) when you previously used Foodprint? "))
